...
enum Gender GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_NORMAL:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_MACH_BIKE:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_ACRO_BIKE:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_SURFING:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_UNDERWATER:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_FIELD_MOVE:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_FISHING:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_WATERING:
    case OBJ_EVENT_GFX_MAGMA_GRUNT_F_DECORATING:
        return FEMALE;
    default:
        return MALE;
    }
