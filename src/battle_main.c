...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_RICH_BOY] = { _("Wealthy"), 50 },
    ...
    [TRAINER_CLASS_CHAMPION] = { _("Hoenn Champion"), 50, BALL_ULTRA },
    ...
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("Kanto Champion"), 25 },
    ...
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("Siblings"), 1 },
