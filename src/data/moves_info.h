...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    [MOVE_NONE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_HYBRID,
    ...
    [MOVE_COUNTER] =
    {
        ...
        .argument = {
            ...
            .reflectDamage.damageCategories = 1u << DAMAGE_CATEGORY_HYBRID,
        },
    ...
    [MOVE_METAL_BURST] =
    {
        ...
        .argument = {
            ...
            .reflectDamage.damageCategories = 1u << DAMAGE_CATEGORY_HYBRID | 1u << DAMAGE_CATEGORY_HYBRID,
        },
        .ignoresProtect = B_UPDATED_MOVE_FLAGS < GEN_5,
        .meFirstBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_LAST,
    ...
    [MOVE_WATER_SHURIKEN] =
    {
        ...
        .target = TARGET_SELECTED,
        .priority = 1,
        .category = B_UPDATED_MOVE_DATA >= GEN_7 ? DAMAGE_CATEGORY_HYBRID : DAMAGE_CATEGORY_HYBRID,
        .argument = {
    ...
    [MOVE_BREAKNECK_BLITZ] =
    {
        ...
        .target = TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_HYBRID,    //determined from move type
