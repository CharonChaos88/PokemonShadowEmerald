...
static const u8 sPartyMenuSpriteCoords[PARTY_LAYOUT_COUNT][PARTY_SIZE][4 * 2] =
{
    [PARTY_LAYOUT_SINGLE] =
    {
        { 24,  14, 110,  15,  26,  33,  24,  18},
        {136,  22, 220,  23, 138,  41, 136,  26},
        { 24,  54, 109,  55, 26,   73,  24,  58},
        {136,  62, 221,  63, 138,  81, 136,  66},
        { 24,  94, 109,  95, 26,  113,  24,  98},
        {136, 102, 221, 103, 138, 121, 136, 106},
    },
    [PARTY_LAYOUT_DOUBLE] =
    {
        { 24,  14, 110,  15,  26,  33,  24,  18},
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_STAT_EDITOR] =                        {gText_StatEditor, CursorCb_StatEdit},
    ...
    [MENU_TAKE_SAMPLE]     = {COMPOUND_STRING("Take Sample"),     CursorCb_TakeSample},
};
