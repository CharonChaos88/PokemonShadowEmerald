...
const u8 gText_TrainerCardIDNo[] = _("Hoenn ID: ");
const u8 gText_TrainerCardMoney[] = _("PokéDollar: ");
...
const u8 gText_StatEditor[] = _("Change Stats");
...
//names
const u8 gText_SideQuestName_1[] = _("The Bad Egg Virus");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Find the origins of the Bad Egg Virus.\nResearch about the virus.\nFind a cure for it as soon as possible.");
...
const u8 gText_SideQuestMap2[] = _("Hoenn Region");
const u8 gText_SideQuestMap3[] = _("Petalburg Woods");
const u8 gText_SideQuestMap4[] = _("Anywhere in Hoenn");
const u8 gText_SideQuestMap5[] = _("Anywhere in Hoenn");
const u8 gText_SideQuestMap6[] = _("Professor Birch's Lab");
...
//subquests
const u8 gText_SubQuest1_Name1[] = _("Into the Wilderness");
const u8 gText_SubQuest1_Name2[] = _("Evolving Wurmple");
const u8 gText_SubQuest1_Name3[] = _("Into the Forest");
const u8 gText_SubQuest1_Name4[] = _("Taking Samples");
const u8 gText_SubQuest1_Name5[] = _("Collecting Shells");
const u8 gText_SubQuest1_Name6[] = _("Creating a Vaccine");
const u8 gText_SubQuest1_Name7[] = _("Bad Egg");
...
const u8 gText_SubQuest1_Desc1[] = _("Look for a Wurmple.");
const u8 gText_SubQuest1_Desc2[] = _("Evolve Wurmple into\netiher Silcoon or Cascoon.");
const u8 gText_SubQuest1_Desc3[] = _("Obtain three Bug types\nthat are not part\nof the Wurmple family.");
const u8 gText_SubQuest1_Desc4[] = _("Take a sample from Silcoon and\nCascoon. If you're missing either one\ngo to the Petalburg Woods.");
const u8 gText_SubQuest1_Desc5[] = _("Collect 30 Silcoon & Cascoon Shells.");
const u8 gText_SubQuest1_Desc6[] = _("Create six Casilcoon Vaccines.");
