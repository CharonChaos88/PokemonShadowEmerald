...
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("Drake's Cottage"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
...
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("Mauville Power Plant"), FLAG_LANDMARK_NEW_MAUVILLE};
...
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("Icefall Cave"), FLAG_LANDMARK_ISLAND_CAVE};
...
static const struct Landmark Landmark_TrainerHill = {COMPOUND_STRING("Pokémon Facility"), FLAG_LANDMARK_TRAINER_HILL};
