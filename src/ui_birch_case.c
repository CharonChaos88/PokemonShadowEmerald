...
static const struct MonChoiceData sStarterChoices[3][9] = 
{
    // PAGE 0: Hoenn, Johto, Kanto
    {
        ...
        [BALL_TOP_SECOND]       = {SPECIES_TREECKO, 5, GRASS_STARTER, ITEM_NONE, BALL_POKE, NUM_NATURES, 3, 2, {0, 0, 0, 0, 0,}, {31, 31, 31, 31, 31, 31,}, {MOVE_POUND, MOVE_LEER, MOVE_LEAFAGE, MOVE_QUICK_ATTACK,}},
