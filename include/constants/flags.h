...
#define FLAG_FIRST_BEV_INFECTION    0x20 // Set when the player's Pokemon catches the Bad Egg Virus for the first time
...
#define FLAG_MYSTERY_GIFT_16                 0x1F4
#define FLAG_MYSTERY_GIFT_17                 0x1F5

// Hidden Items
#define FLAG_HIDDEN_ITEMS_START                                                         0x1F6
