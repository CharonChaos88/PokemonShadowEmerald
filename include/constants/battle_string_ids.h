...
enum StringID
{
    ...
    STRINGID_ZIGZAGMERANG_GATHERED,
    STRINGID_LINOONMERANG_GATHERED_1,
    STRINGID_LINOONMERANG_GATHERED_2,
    STRINGID_LINOONMERANG_GATHERED_3,
    STRINGID_BOTH_BOOMERANGS_GATHERED,
    STRINGID_COUNT
};
