...
#define PLAYER_AVATAR_GFX_MALE_NORMAL     (IS_FRLG ? OBJ_EVENT_GFX_RED_NORMAL     : OBJ_EVENT_GFX_MAGMA_GRUNT_M_NORMAL)
#define PLAYER_AVATAR_GFX_MALE_MACH_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_RED_BIKE       : OBJ_EVENT_GFX_MAGMA_GRUNT_M_MACH_BIKE)
#define PLAYER_AVATAR_GFX_MALE_ACRO_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_RED_BIKE       : OBJ_EVENT_GFX_MAGMA_GRUNT_M_ACRO_BIKE)
#define PLAYER_AVATAR_GFX_MALE_SURFING    (IS_FRLG ? OBJ_EVENT_GFX_RED_SURF       : OBJ_EVENT_GFX_MAGMA_GRUNT_M_SURFING)
#define PLAYER_AVATAR_GFX_MALE_UNDERWATER (IS_FRLG ? OBJ_EVENT_GFX_RED_SURF       : OBJ_EVENT_GFX_MAGMA_GRUNT_M_UNDERWATER)
#define PLAYER_AVATAR_GFX_MALE_FIELD_MOVE (IS_FRLG ? OBJ_EVENT_GFX_RED_FIELD_MOVE : OBJ_EVENT_GFX_MAGMA_GRUNT_M_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_MALE_FISHING    (IS_FRLG ? OBJ_EVENT_GFX_RED_FISH       : OBJ_EVENT_GFX_MAGMA_GRUNT_M_FISHING)
#define PLAYER_AVATAR_GFX_MALE_WATERING   (IS_FRLG ? OBJ_EVENT_GFX_RED_FIELD_MOVE : OBJ_EVENT_GFX_MAGMA_GRUNT_M_WATERING)
#define PLAYER_AVATAR_GFX_MALE_VSSEEKER   (IS_FRLG ? OBJ_EVENT_GFX_RED_VS_SEEKER  : OBJ_EVENT_GFX_MAGMA_GRUNT_M_DECORATING)

#define PLAYER_AVATAR_GFX_FEMALE_NORMAL     (IS_FRLG ? OBJ_EVENT_GFX_GREEN_NORMAL     : OBJ_EVENT_GFX_MAGMA_GRUNT_F_NORMAL)
#define PLAYER_AVATAR_GFX_FEMALE_MACH_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_GREEN_BIKE       : OBJ_EVENT_GFX_MAGMA_GRUNT_F_MACH_BIKE)
#define PLAYER_AVATAR_GFX_FEMALE_ACRO_BIKE  (IS_FRLG ? OBJ_EVENT_GFX_GREEN_BIKE       : OBJ_EVENT_GFX_MAGMA_GRUNT_F_ACRO_BIKE)
#define PLAYER_AVATAR_GFX_FEMALE_SURFING    (IS_FRLG ? OBJ_EVENT_GFX_GREEN_SURF       : OBJ_EVENT_GFX_MAGMA_GRUNT_F_SURFING)
#define PLAYER_AVATAR_GFX_FEMALE_UNDERWATER (IS_FRLG ? OBJ_EVENT_GFX_GREEN_SURF       : OBJ_EVENT_GFX_MAGMA_GRUNT_F_UNDERWATER)
#define PLAYER_AVATAR_GFX_FEMALE_FIELD_MOVE (IS_FRLG ? OBJ_EVENT_GFX_GREEN_FIELD_MOVE : OBJ_EVENT_GFX_MAGMA_GRUNT_F_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_FEMALE_FISHING    (IS_FRLG ? OBJ_EVENT_GFX_GREEN_FISH       : OBJ_EVENT_GFX_MAGMA_GRUNT_F_FISHING)
#define PLAYER_AVATAR_GFX_FEMALE_WATERING   (IS_FRLG ? OBJ_EVENT_GFX_GREEN_FIELD_MOVE : OBJ_EVENT_GFX_MAGMA_GRUNT_F_WATERING)
#define PLAYER_AVATAR_GFX_FEMALE_VSSEEKER   (IS_FRLG ? OBJ_EVENT_GFX_GREEN_VS_SEEKER  : OBJ_EVENT_GFX_MAGMA_GRUNT_F_DECORATING)
...
enum
{
    ...
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_NORMAL,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_MACH_BIKE,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_ACRO_BIKE,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_SURFING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_UNDERWATER,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_FIELD_MOVE,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_FISHING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_WATERING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_M_DECORATING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_NORMAL,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_MACH_BIKE,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_ACRO_BIKE,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_SURFING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_UNDERWATER,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_FIELD_MOVE,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_FISHING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_WATERING,
    OBJ_EVENT_GFX_MAGMA_GRUNT_F_DECORATING,
    OBJ_EVENT_GFX_LINK_BRENDAN_MACH_BIKE,
    OBJ_EVENT_GFX_LINK_BRENDAN_SURFING,
    OBJ_EVENT_GFX_LINK_BRENDAN_FIELD_MOVE,
    OBJ_EVENT_GFX_LINK_BRENDAN_UNDERWATER,
    OBJ_EVENT_GFX_LINK_BRENDAN_WATERING,
    OBJ_EVENT_GFX_LINK_BRENDAN_DECORATING,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_FIELD_MOVE,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_SURFING,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_MACH_BIKE,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_ACRO_BIKE,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_FISHING,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_WATERING,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_DECORATING,
    OBJ_EVENT_GFX_LINK_RS_BRENDAN_UNDERWATER,
    OBJ_EVENT_GFX_LINK_RS_MAY_FIELD_MOVE,
    OBJ_EVENT_GFX_LINK_RS_MAY_SURFING,
    OBJ_EVENT_GFX_LINK_RS_MAY_MACH_BIKE,
    OBJ_EVENT_GFX_LINK_RS_MAY_ACRO_BIKE,
    OBJ_EVENT_GFX_LINK_RS_MAY_FISHING,
    OBJ_EVENT_GFX_LINK_RS_MAY_WATERING,
    OBJ_EVENT_GFX_LINK_RS_MAY_DECORATING,
    OBJ_EVENT_GFX_LINK_RS_MAY_UNDERWATER,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_MAGMA_GRUNT_M           0x1134
#define OBJ_EVENT_PAL_TAG_MAGMA_GRUNT_M_REFLECTION           0x1135
#define OBJ_EVENT_PAL_TAG_MAGMA_GRUNT_F                     0x1136
#define OBJ_EVENT_PAL_TAG_MAGMA_GRUNT_F_REFLECTION           0x1137
