...
#define BW_IV_EV_HIDDEN                             1       // don't show IVs and EVs
#define BW_IV_EV_GRADED                             0      // show graded values for IVs and EVs
#define BW_IV_EV_PRECISE                            0       // show precise values for IVs and EVs
