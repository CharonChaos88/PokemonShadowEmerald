...
extern const u32 gItemIcon_CascoonSample[];
extern const u16 gItemIconPalette_CascoonSample[];
extern const u32 gItemIcon_SilcoonSample[];
extern const u16 gItemIconPalette_SilcoonSample[];
extern const u32 gItemIcon_BeautiflySample[];
extern const u16 gItemIconPalette_BeautiflySample[];
extern const u32 gItemIcon_DustoxSample[];
extern const u16 gItemIconPalette_DustoxSample[];
extern const u32 gItemIcon_ButterfreeSample[];
extern const u16 gItemIconPalette_ButterfreeSample[];
extern const u32 gItemIcon_BeedrillSample[];
extern const u16 gItemIconPalette_BeedrillSample[];
extern const u32 gItemIcon_SilcoonShell[];
extern const u16 gItemIconPalette_SilcoonShell[];
extern const u32 gItemIcon_CascoonShell[];
extern const u16 gItemIconPalette_CascoonShell[];
extern const u32 gItemIcon_KakunaShell[];
extern const u16 gItemIconPalette_KakunaShell[];
extern const u32 gItemIcon_MetapodShell[];
extern const u16 gItemIconPalette_MetapodShell[];
extern const u32 gItemIcon_ButterdrillVaccine[];
extern const u16 gItemIconPalette_ButterdrillVaccine[];
extern const u32 gItemIcon_DustoxiflyVaccine[];
extern const u16 gItemIconPalette_DustoxiflyVaccine[];
