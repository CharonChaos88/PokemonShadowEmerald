...
struct SaveBlock2
{
    ...
    /*0x13*/ u8 optionsButtonMode:2;  // OPTIONS_BUTTON_MODE_[NORMAL/LR/L_EQUALS_A]
             ...
             u16 optionsBattleMusic:5; // select one of 17 options (default, random, 17 tracks)
...
struct SaveBlock1
{
    ...
    /*0x3030*/ struct DayCare daycare;
                   struct BevTracker bevTrackers[PARTY_SIZE];
    u16 globalPcVirusClock;        // NEW: Tracks time for the PC sweep
